// BTMS — the thermal management SYSTEM layer: loop selection, first-order
// coolant flow (ṁ = Q/(c_p·ΔT)), chiller coupling to the higher system, the
// heater decision, and the BTMS control unit that only exists for active
// systems.
...
test('loop selection scales with heat and climate', () => {
...
test('the selected hardware floors the loop', () => {
...
test('first-order flow math (brief §6.3)', () => {
...
test('the chiller couples to the HIGHER system', () => {
...
test('the heater decision comes from the climate window', () => {
...
test('the BTMS control unit exists only for active systems', () => {
...
test('suggested parts per side, named from the customer\'s own selection', () => {
...
test('ram-air applications: real heat, free airflow, nothing to buy', () => {
...
test('choice assessments: physics-backed verdicts', () => {
