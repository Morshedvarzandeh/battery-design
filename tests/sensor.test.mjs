// Sensors — the plan by level: counts, and — the whole point — OMISSION.
// A wearable never lists coolant sensors, a drone never lists a runaway
// detector, a passive pack has no cooling group at all.
...
test('wearable: 1S LiPo, passive — nothing that isn\'t there', () => {
...
test('a chiller loop adds the refrigerant interface', () => {
  const c = cellById('samsung-inr21700-50e');
  const summary = mkSummary(c, 96, 2);
...
test('large LFP ESS: runaway detection still recommended (gas)', () => {
