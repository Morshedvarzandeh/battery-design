...
// 1. Empty-layer guard: gridDims must reject phantom layers
...
// 3. Hot-charge warn present
const L = layoutPack(c, 13, 4, {});
const S = summarize(c, 13, 4, L);
const ctx = {
  cell: c, s: 13, p: 4,
  pack: { nominalV: S.nominalV, vMax: S.vMax, vMin: S.vMin, capacityAh: S.capacityAh,
