...
| Reference | Scope | Used for | Module |
|---|---|---|---|
| [**Regulation (EU) 2023/1542 — consolidated 31 July 2025**](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:02023R1542-20250731) | Batteries and waste batteries (repealing Directive 2006/66/EC) | The Rules tab timeline and applicability: Article 7 carbon dates use the latest nominal-or-dependent-act date and remain unresolved when an entry-into-force date is missing; Article 77 passport for LMT batteries, EV batteries and industrial batteries >2 kWh from 18 February 2027; Article 14 state-of-health access; recycled-content targets; and the deliberately separate **recycling efficiency** and **material recovery** metrics. Non-EV/LMT applications require a declared battery category rather than an energy-based industrial guess | `eurules.js` |
| [**Regulation (EU) 2025/1561**](https://eur-lex.europa.eu/eli/reg/2025/1561/oj/eng) | Amendment to battery due-diligence timing | Supersedes the former Article 48(1) date with 18 August 2027 and the former Article 48(5) Commission-guidance deadline with 26 July 2026. The guidance deadline is modeled separately and does not gate operator obligations; the design check leaves Article 47 company scope and product-history conditions to company-level evidence | `eurules.js` |
...
| Host machine silhouettes | class-typical overall dimensions per machine kind (car 4.4 m, bus 12 m, small craft 7 m, …) | The 3D showroom needs somewhere to put the pack. Where the application has a vehicle model, the CROSS-SECTION is derived from its measured frontal area and the scene says so; the length, and everything about machines with no vehicle model, is class-typical. The silhouette is a massing block, never a drawing, and the pack inside it is at true scale — so an oversized pack visibly bursts out rather than the machine rescaling around it |
| Frontal-area fill factor | 0.85 | No vehicle is a rectangle, so width × height overstates the frontal area. A first-order figure for a car-like body, used only to turn a measured frontal area back into a silhouette cross-section |
