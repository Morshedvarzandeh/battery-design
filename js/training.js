...
//
// Steps carry a `concept` tag from knowledge.js. The driver filters the
// track through the knowledge graph for the active application, so a
// wearable customer never meets the stacks/EMS steps — the graph decides,
// not this file. Untagged steps are universal.
...
export const TRAINING_TRACKS = {
  simple: {
    ...
    steps: [
      ...
      {
        tab: 'fit', title: '4 · Pick a scenario', concept: 'multi-objective',
      ...
      {
        tab: 'results', title: 'Done — the report', concept: 'report',
  ...
  advanced: {
    ...
    steps: [
      {
        tab: 'usage', title: '1 · Duty is money', concept: 'duty-economics',
      ...
      {
        tab: 'usage', title: '2 · Seasons set the corners', concept: 'seasons',
      ...
      {
        tab: 'usage', title: '3 · Big systems are stacks', concept: 'stacks-racks',
      ...
      {
        tab: 'fit', title: '4 · The optimizer is multi-objective', concept: 'multi-objective',
      ...
      {
        tab: 'fit', title: '5 · The integration allowance is real', concept: 'integration-allowance',
      ...
      {
        tab: 'design', title: '5b · Why the spaces exist', concept: 'spaces-why',
      ...
      {
        tab: 'analysis', title: '6 · The architecture is part of electrical', concept: 'bms-topology',
      ...
      {
        tab: 'analysis', title: '6a · The EMS has architectures too', concept: 'ems-arch',
      ...
      {
        tab: 'results', title: '8 · Stress-test the decision', concept: 'report',
