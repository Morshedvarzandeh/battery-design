...
export const CELLS = [
  ...
  // ── Wearable "LiPo" pouches ─────────────────────────────────────────────
  // What the wearable market calls "LiPo" is an LCO-family cell in a small
  // polymer pouch, named by its T-W-H millimetre code (401020 = 4.0 x 10 x
  // 20 mm). Single-cell (1S) systems with a fuel gauge, charged daily.
  {
    id: 'lipo-401020-60mah',
    name: 'Wearable LiPo 401020 (60 mAh class)',
    manufacturer: 'Generic',
    model: '401020 wearable pouch (EEMB/PKCELL/Grepow class)',
    form: 'pouch',
    formFactor: 'lipo pouch',
    chemistry: 'LCO',
    dims: { w: 10, t: 4, h: 20 },
    massG: 1.3,
    capacityAh: 0.06,
    ...
    vMax: 4.2,
    vMin: 3.0,
    maxContDischargeA: 0.06,
    maxPulseDischargeA: 0.12,
    maxContChargeA: 0.03,
    dcirMOhm: 300,
    cycleLife: 300,
    tempDischargeC: [-20, 60],
    ...
    contribUid: null,
    inferredFields: ['ALL'],
    sourceNote: 'Composite of 401020-class wearable LiPo datasheets (EEMB/PKCELL/Grepow style): ~60 mAh, 1C continuous / 2C pulse / 0.5C charge, ~300 cycles to 80%. Smart-band / earbud-case class. All values class-typical estimates, not one SKU.'
  },
  {
    id: 'lipo-602030-300mah',
    name: 'Wearable LiPo 602030 (300 mAh class)',
    manufacturer: 'Generic',
    model: '602030 wearable pouch (EEMB/PKCELL/Grepow class)',
    form: 'pouch',
    formFactor: 'lipo pouch',
    chemistry: 'LCO',
    dims: { w: 20, t: 6, h: 30 },
    ...
    vMax: 4.2,
    vMin: 3.0,
    maxContDischargeA: 0.3,
    maxPulseDischargeA: 0.6,
    maxContChargeA: 0.15,
    dcirMOhm: 150,
    cycleLife: 400,
    tempDischargeC: [-20, 60],
    ...
    contribUid: null,
    inferredFields: ['ALL'],
    sourceNote: 'Composite of 602030-class wearable LiPo datasheets: ~300 mAh, 1C continuous / 2C pulse / 0.5C charge, ~400 cycles to 80%. Smartwatch class. All values class-typical estimates, not one SKU.'
  },
  {
    id: 'lipo-802540-800mah',
    name: 'Smart-device LiPo 802540 (800 mAh class)',
    manufacturer: 'Generic',
    model: '802540 device pouch (EEMB/PKCELL/Grepow class)',
    form: 'pouch',
    formFactor: 'lipo pouch',
    chemistry: 'LCO',
    dims: { w: 25, t: 8, h: 40 },
    ...
    vMax: 4.2,
    vMin: 3.0,
    maxContDischargeA: 0.8,
    maxPulseDischargeA: 1.6,
    maxContChargeA: 0.4,
    dcirMOhm: 90,
    cycleLife: 500,
    tempDischargeC: [-20, 60],
    ...
    contribUid: null,
    inferredFields: ['ALL'],
    sourceNote: 'Composite of 802540-class device LiPo datasheets: ~800 mAh, 1C continuous / 2C pulse / 0.5C charge, ~500 cycles to 80%. AR glasses / handheld / large-watch class. All values class-typical estimates, not one SKU.'
  },
