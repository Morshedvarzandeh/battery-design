...
<fmiModelDescription
  ...
  guid="${xmlEscape(id)}"
  description="Battery pack model exported by battery-design (Apache-2.0). Equivalent circuit with RC dynamics and a lumped thermal node; the same model as js/sim2.js, with the same parameters."
 ...
 *
 * Generated by battery-design (Apache-2.0). The physics matches js/sim2.js:
...
Exported by battery-design (Apache-2.0). This is the ${s}S${p}P pack of
